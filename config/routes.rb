Rails3BootstrapDeviseCancan::Application.routes.draw do
  ...
  resources :users, only: [:index, :create, :show, :update]  do
    ...
    member do
      get :following, :following_count, :searchfollowing, :followers, :followers_count, :searchfollowers, :recentfollowers, :friendrequests, :myrelationship, :myreverserelationship, :venues, :microposts, :feed, :feedtender, :feedpopular, :feedlocal, :valid, :search
    end
    member do
