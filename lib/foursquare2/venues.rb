module Foursquare2
  module Venues
    ...
    # @option options String :novelty - Pass new or old to limit results to venues the acting user hasn't been or has been, respectively. Omitting this parameter returns a mixture.
