class UsersController < ApplicationController
  ...
  def invitationemailonly
    ...
    <p>Hello #{@email}!</p>
    <br/>
    <p>#{@name} has invited you to try out YipTip, a new app sthat lets you stay in touch with your favorite bartenders.</p>
    ...
    <br/>
    <p>Learn more and download the app for iPhone at <a href='https://www.yiptip.com'>yiptip.com</a>.</p>"
